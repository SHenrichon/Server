...
final class HTTPHandler<Responder: HTTPResponder>: ChannelInboundHandler {
    ...
    func channelRead(ctx: ChannelHandlerContext, data: NIOAny) {
        ...
        case .head(let requestHead):
            ...
            closeAfterResponse = !requestHead.isKeepAlive
            ...
            if contentLength > 0 {
                ...
                body = ctx.channel.allocator.buffer(capacity: contentLength)
            ...
            request = HTTPRequest(eventLoop: ctx.eventLoop, head: requestHead, bodyBuffer: body)

        case .body(var newData):

            // Appends new data to the already reserved buffer

            request?.bodyBuffer?.write(buffer: &newData)
